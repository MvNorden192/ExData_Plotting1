...
## Graph 2
with(data_to_use, plot(Voltage ~ NewDate, type = "n", ylab = "Voltage", xlab = "datetime"))
with(data_to_use, lines(Voltage ~ NewDate))
...
## Graph 4
with(data_to_use, plot(Global_reactive_power ~ NewDate, type = "n", ylab = "Voltage", xlab = "Global_reactive_power"))
with(data_to_use, lines(Global_reactive_power ~ NewDate))
